...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference("Balance.count") do
      post balances_url, params: { balance: { balanceA: @balance.balanceA, balanceI: @balance.balanceI } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { balanceA: @balance.balanceA, balanceI: @balance.balanceI } }
