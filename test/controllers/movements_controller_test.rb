...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { amount: @movement.amount, description: @movement.description, type_account: @movement.type_account, type_movement: @movement.type_movement } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, description: @movement.description, type_account: @movement.type_account, type_movement: @movement.type_movement } }
